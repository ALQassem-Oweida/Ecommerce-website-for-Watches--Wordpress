...
final class WOOF_META_FILTER extends WOOF_EXT {
    ...
    public function woof_print_html_type_options_meta() {//old
        ...
        <li data-key="<?php echo $key ?>" class="woof_options_li">
            ...
            <img class="help_tip" data-tip="<?php esc_html_e('Meta filter', 'woocommerce-products-filter') ?>" src="<?php echo WP_PLUGIN_URL ?>/woocommerce/assets/images/help.png" height="16" width="16" />
            ...
            <input type="button" value="<?php esc_html_e('additional options', 'woocommerce-products-filter') ?>" data-key="<?php echo $key ?>" data-name="<?php echo $this->woof_settings['meta_filter'][$key]['title'] ?>" class="woof-button js_woof_options js_woof_options_<?php echo $key ?>" />
            <?php
            $data = array();
            $data['key'] = $key;
