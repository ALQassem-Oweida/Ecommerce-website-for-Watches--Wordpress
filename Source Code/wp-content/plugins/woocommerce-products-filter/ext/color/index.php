...
final class WOOF_EXT_COLOR extends WOOF_EXT {
    ...
    public function print_additional_options($key) {
        ...
        if (!empty($terms)) {
            ?>
            <br /><a href="javascript:void(0);" class="button woof_toggle_colors"><?php esc_html_e('toggle color terms', 'woocommerce-products-filter') ?></a><br />
