...
<li data-key="<?php echo $key ?>" class="woof_options_li">
    ...
    <img class="help_tip" data-tip="<?php esc_html_e('Show textinput for searching by products sku', 'woocommerce-products-filter') ?>" src="<?php echo WP_PLUGIN_URL ?>/woocommerce/assets/images/help.png" height="16" width="16" />
    ...
    <input type="button" value="<?php esc_html_e('additional options', 'woocommerce-products-filter') ?>" data-key="<?php echo $key ?>" data-name="<?php esc_html_e("Search by SKU", 'woocommerce-products-filter'); ?>" class="woof-button js_woof_options js_woof_options_<?php echo $key ?>" />
    ...
    <div id="woof-modal-content-<?php echo $key ?>" style="display: none;">
        ...
        <div class="woof-form-element-container">
            ...
            <div class="woof-name-description">
                ...
                <span><?php esc_html_e('Any notes for customer.<br /><b>Example</b>: use comma for searching by more than 1 SKU!', 'woocommerce-products-filter') ?></span>
            </div>
