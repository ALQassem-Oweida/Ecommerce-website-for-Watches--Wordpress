...
class Urna_Facebook_Like_Box extends Urna_Widget {
    public function __construct() {
        parent::__construct(
            'urna_facebook_like',
            esc_html__('Urna Facebook Like Box', 'urna-core'),
            array( 'description' => esc_html__( 'Adds support for Facebook Like Box. ', 'urna-core' ), )
        );
...
register_widget( 'Urna_Facebook_Like_Box' );