...
<div class="rm-modal-view" id="rm-conditional-modal" style="display:none">
    <div class="rm-modal-overlay rm-field-popup-overlay-fade-in" style="display:none" onClick="showConditionFormModal()"></div>
        <div class="rm-modal-wrap rm-field-popup-out">
            <div class="rm-modal-titlebar">
                <div class="rm-modal-title">  <?php echo wp_kses_post(RM_UI_Strings::get('LABEL_CONDITIONS')); ?> for <span id="selected_field"></span></div>
                        ...
                        <div style="<?php echo esc_attr($display); ?>" class="rm-condition" id="rm_condition_<?php echo esc_attr($field->field_id); ?>" data-field-name="<?php echo ucwords(esc_attr($field->field_label)); ?>"> 
                                ...
                                <div class="rm-field-conditions-wrap">
                                    <div class="rm-field-conditions-title">
                                        ...
                                        <div class="rm-field-conditions-delete"><a href="javascript:void(0)" onclick="delete_all(<?php echo esc_attr($field->field_id); ?>)"><?php _e('Delete','custom-registration-form-builder-with-submission-manager'); ?></a> </div>
                                         
                                    </div> 
                                    <div  class="rm-field-condition-container rm-combinator-container" id="rm-container-field-<?php echo esc_attr($field->field_id); ?>">
                                        ...
                                        ?>   
                                            <div class="rm-field-condition-row">
                                                <div class="rm-controlling-atr">
                                                    <div class="rminput">
                                                            <?php RM_Utilities::get_fields_dropdown(array('form_id' => $data->form_id,'full' => true, 'name' => 'cfields[]','def'=>$condition['controlling_field'],'exclude'=>array($field->field_id),'ex_by_type'=>$excluded_fields)); ?>
                                                    </div>
                                                </div>
                                                <div class="rm-controlling-atr">
                                                    <div class="rminput">
                                                ...
                                                <div class="rm-controlling-atr">
                                                    <div class="rminput">
                                                        ...
                                                        ?>
                                                        <input type="text" class="<?php echo ($condition['op']=='_blank' || $condition['op']=='_not_blank')?'rm-block-input':''; ?>" value="<?php echo esc_attr($values); ?>" name="values[]" placeholder="Value"  maxlength="50" />
                                                    </div>
                                                </div>
                                   ...
                                   <div class="rm-add-condition-row">  <a onclick="addConditionForm(<?php echo esc_html($field->field_id); ?>)" href="javascript:void(0)"><?php _e('Add','custom-registration-form-builder-with-submission-manager'); ?></a></div> 
