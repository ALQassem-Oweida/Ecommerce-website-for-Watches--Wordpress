    ...
    <div class="rmagic">
        <div class="rmagic-reports">
            <div class="rm-reports-dashboard rm-box-title rm-box-mb-25">
                <?php _e('Form Submissions Report','custom-registration-form-builder-with-submission-manage');?>
            </div>
                            ...
                            <div class="rm-report-form rm-box-row rm-box-bottom">
                                        ...
                                        <div class="rm-box-row">
                                            <div class="rm-box-col-6">
                                                <div class="rm-report-filter-attr">
                                                    <label><?php _e('Date', 'custom-registration-form-builder-with-submission-manage'); ?></label>
                                            ...
                                            <div class="rm-box-col-6">
                                                <div class="rm-report-filter-attr">
                                                    <label><?php _e('Select Form', 'custom-registration-form-builder-with-submission-manage'); ?></label>
                                                    <select class="" name="rm_form_id"><option value="all"><?php _e('All', 'custom-registration-form-builder-with-submission-manage'); ?></option><?php echo $forms; ?></select>
                                                </div>
                                            </div>
                                ...
                                <div class="rm-box-col-3">
                                    <div class="rm-box-btn-wrap rm-box-text-right">  
                                        <button type="submit" id="rm_submit_btn" class="rm_btn rm-btn rm-btn-primary"><?php _e('Search', 'custom-registration-form-builder-with-submission-manage'); ?></button>
                                        <button type="button" id="rm_reset_btn" class="rm-btn-secondary rm-btn" onclick="window.location.href='<?php echo admin_url('?page=rm_reports_submissions'); ?>'"><?php _e('Reset', 'custom-registration-form-builder-with-submission-manage'); ?></button>
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="rm-reports-submission">
                ...
                <div class="rm-reports-submissions-preview rm-report-preview">
                    <div class="rm-reports-preview-title rm-box-title rm-box-mb-25"><?php _e('Preview','custom-registration-form-builder-with-submission-manage');?></div>
                    <div class="rm-reports-preview-sub-title rm-box-sub-title rm-box-mb-25"><?php _e('This preview only displays initial few rows of the generated report. The downloaded file will have complete report data.','custom-registration-form-builder-with-submission-manage');?></div>
                    <table class="rm-report-submission-tables rm-reports-table">
                        <thead>
                        <tr>
                            <th><?php _e('Date','custom-registration-form-builder-with-submission-manage'); ?></th>
                            <th><?php _e('Email','custom-registration-form-builder-with-submission-manage'); ?></th>
                            <th><?php _e('Form ID','custom-registration-form-builder-with-submission-manage'); ?></th>
                            <th><?php _e('View','custom-registration-form-builder-with-submission-manage'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                ...
                <?php else:?>
                    <div class="rmagic-cards"><div class="rm-reports-no-data-found rmnotice rm-box-border rm-box-mb-25"><?php _e('No data found.','custom-registration-form-builder-with-submission-manage');?></div></div>
                <?php
                endif;?>
