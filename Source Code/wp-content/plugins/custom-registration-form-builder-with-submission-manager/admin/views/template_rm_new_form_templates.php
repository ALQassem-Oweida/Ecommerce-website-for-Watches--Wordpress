                            ...
                            <li class="form-contact form_temp_bullet">
                                <div class="rm-temp-card">
                                    ...
                                    <div class="rm-temp-footer">
                                        <button class="rm-form-template-btn" data-tempid="<?php echo $template['id'];?>" data-type="basic" data-title="<?php echo $template['title'];?>" data-submit="Submit" data-submitalign="center" type="button"><?php _e('Use Template','custom-registration-form-builder-with-submission-manager');?></button>                                
                                    </div>
                                </div>
                            </li>
                            <?php
