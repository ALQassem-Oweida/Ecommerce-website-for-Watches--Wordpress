    ...
    <div class="rmagic">
        <div class="rmagic-reports">
            <div class="rm-reports-dashboard rm-box-title rm-box-mb-25 ">
                <?php _e('Login Records Report','custom-registration-form-builder-with-submission-manage');?>
            </div>
                                ...
                                <div class="rm-report-form rm-box-row rm-box-bottom">
                                    <div class="rm-box-col-8">
                                        <div class="rm-box-row">
                                            ...
                                            <div class="rm-box-col-6">    
                                                <div class="rm-report-filter-attr">
                                                    <label><?php _e('Status', 'custom-registration-form-builder-with-submission-manage'); ?></label>
                                    ...
                                    <div class="rm-box-col-3">
                                        <div class="rm-box-btn-wrap rm-box-text-right">
                                           <button type="submit" id="rm_submit_btn" class="rm-btn-primary rm-btn"><?php _e('Search', 'custom-registration-form-builder-with-submission-manage'); ?></button>
                                           <button type="button" id="rm_reset_btn" class="rm-btn-secondary rm-btn" onclick="window.location.href='<?php echo admin_url('?page=rm_reports_login'); ?>'"><?php _e('Reset', 'custom-registration-form-builder-with-submission-manage'); ?></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                ...
                <div class="rm-reports-submissions-preview rm-report-preview">
                    ...
                    <table class="rm-report-submission-tables rm-reports-table">
                        ...
                        <tr>
                            ...
                            <th><?php _e('Username Used','custom-registration-form-builder-with-submission-manage'); ?></th>
                            <th><?php _e('Email','custom-registration-form-builder-with-submission-manage'); ?></th>
                            <th><?php _e('Result','custom-registration-form-builder-with-submission-manage'); ?></th>
                            <th><?php _e('Browser','custom-registration-form-builder-with-submission-manage'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
