    ...
    <div class="rm-task-setting-wrap">
        ...
        <form name="rmc_task_settings_form" id="rmc_task_settings_form" action="" method="post" style="display:none">
            ...
            <div class="rm-task-slide rm-task-slide4">
                ...
                ?>
                <div class="childfieldsrow" id="rmc_enable_crons" style="<?php echo $automatic_active; ?>">  
                    <div class="rmrow">
                        <div class="rmfield" for="rmc_task_name">
                            <label><b><?php _e('Starts On','custom-registration-form-builder-with-submission-manager'); ?></b><sup class="required">* </sup></label>
                        </div>
                        <div class="rminput">
                            <input type="datetime-local" name="rmc_task_first_execution" id="rmc_task_first_execution" required value="<?php if(isset($data->init_field_config->meta['rmc_task_first_execution'])) { echo str_replace(' ', '', RM_Utilities::localize_time($data->init_field_config->meta['rmc_task_first_execution'], 'Y-m-d\T\ H:i', false, true)); } ?>">
                        </div>
                        <div class="rmnote">
                            <div class="rmprenote"></div>
