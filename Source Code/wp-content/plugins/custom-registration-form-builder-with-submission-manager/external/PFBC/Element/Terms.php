   ...
   public function render()
    {       
       ...
       if(isset($this->_attributes["check_above_tc"]) && $this->_attributes["check_above_tc"] == 1)
           echo "<div class='rm_terms_checkbox'><input ",esc_attr($checked)," ",esc_attr($disabled)," value='on' type='checkbox'", wp_kses_post($this->getAttributes(array("default_value", "value"))),  " class='rm_check_box'>".esc_html($cb_label)."</div>";
