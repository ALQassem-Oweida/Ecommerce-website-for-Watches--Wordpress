                            ...
                            <div class="wideField rm-alone rm-address-hw" colspan="3">
                                ...
                                <script>
                                    jQuery(document).ready(function(){
                                        ...
                                        rm_load_states(selected_country,'<?php echo wp_kses_post($name); ?>_administrative_area_level_1','<?php echo $this->_attributes["state_as_code"] ?>',"<?php echo wp_kses_post($value['state']) ?>");
                                    });
                                </script>
                            </div>
                        <?php endif; ?> 
